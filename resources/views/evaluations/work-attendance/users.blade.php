        ...
        <div class="px-6 py-5">
            <div class="flex items-center gap-4">
                ...
                <div class="w-11 h-11 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center ">
                    <i data-lucide="{{ $office ? 'building' : 'building-2' }}" class="w-5 h-5"></i>
                </div>
                <div>
                    {{-- Department --}}
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-medium text-gray-800">
                    បញ្ជីមន្ត្រីដែលត្រូវវាយតម្លៃសមិទ្ធកម្មការងារ និងវត្តមាន
                </h2>
            </div>
            {{-- Total --}}
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 text-sm font-medium">
        ...
        @if ($users->isEmpty())
            ...
            <div class="px-6 py-12 text-center">
                <i data-lucide="users"
                    class="w-10 h-10 mx-auto text-gray-300 mb-3"></i>
